...
public class UploadUtil {
    ...
    public void uploadFile(final File file, final String fileKey, final String RequestURL, final Map<String, String> param) {
        ...
        new Thread(new Runnable() {  //开启线程上传文件
            @Override
            public void run() {
                toAsyncUploadFile(file, fileKey, RequestURL, param);
            }
        }).start();
     ...
     * @return
     */
    public String toAsyncUploadFile(String file) {
        return toAsyncUploadFile(new File(file), "file", MvpPresenter.URL_UPLOAD, null);
    }
     ...
     * @param param
     */
    public String toAsyncUploadFile(File file, String fileKey, String RequestURL, Map<String, String> param) {
        String result = null;
        requestTime = 0;
        ...
        try {
            ...
            sb.append(LINE_END);
            params = sb.toString();
            Log.i(TAG, file.getAbsolutePath() + "=" + params + "##" + sb.toString());
            sb = null;
    ...
    public static String picPath(String str) {
        try {
